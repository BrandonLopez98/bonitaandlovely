...
const Profile = () => {
  ...
  return (
    ...
    <div >
      ...
      <Online>.</Online>
      {isOpen && (
    <div onMouseEnter={showUserMenu} onMouseLeave={hideUserMenu} className="absolute top-10 right-0 z-20 w-48 bg-white border rounded-md shadow-lg pt-3 mt-7 mr-2">
