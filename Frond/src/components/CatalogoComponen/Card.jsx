...
const Card = ({id,name, precio_venta,imagenPrincipal }) => {
  ...
  return (
    <div className="grid grid-cols-1 rounded-lg bg-white px-5 py-10 relative shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]" >
      ...
      <Link to={`detail/${id}`} className="w-[50%] h-full m-auto"><img className="rounded-lg w-full m-auto shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]" src={imagenPrincipal} alt="a" /></Link>
